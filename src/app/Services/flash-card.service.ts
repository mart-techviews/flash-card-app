...
export class FlashCardService {
  ...
  questions: question[] = [
    ...
    new question('What is localStorage in JavaScript?', 'localStorage is a web storage API that allows you to store data in the browser that persists even after the page is refreshed.')
  ]
